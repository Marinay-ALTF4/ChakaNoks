    ...
    <form action="<?= base_url('suppliers/update/'.$supplier['id']) ?>" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="contact" class="form-control" 
                   value="<?= esc($supplier['contact']) ?>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="address" class="form-control" 
                   value="<?= esc($supplier['address']) ?>" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Branch Serve</label>
            <input type="text" name="branch_serve" class="form-control" 
                   value="<?= esc($supplier['branch_serve']) ?>" required>
        </div>
        <div class="mb-3">
