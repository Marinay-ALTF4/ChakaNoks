...
<div class="container-fluid">
    ...
    <div class="card mb-4" id="supplier-orders-container">
        ...
        <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($pendingOrders as $order): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Central_AD/confirm-supplier-order/'.$order['id']) ?>" class="btn btn-sm btn-success">Confirm</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <?php else: ?>
                <p class="text-muted">No pending orders for supplier confirmation.</p>
            <?php endif; ?>
        </div>
    </div>
                        ...
                        <tbody>
                            <?php foreach ($confirmedOrders as $order): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Central_AD/mark-preparing/'.$order['id']) ?>" class="btn btn-sm btn-primary">Mark as Preparing</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        ...
                        <tbody>
                            <?php foreach ($preparingOrders as $order): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Central_AD/mark-ready-delivery/'.$order['id']) ?>" class="btn btn-sm btn-success">Mark Ready for Delivery</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script>
// Real-time updates for supplier orders page
